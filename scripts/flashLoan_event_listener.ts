...
// const web3 = new Web3('https://eth-sepolia.g.alchemy.com/v2/2nQYF9TNYMKqoaCI2iW_iKjbcr4paCSd');
const web3 = new Web3(new Web3.providers.WebsocketProvider(
    // MAINNET
    // 'wss://lb.drpc.org/ogws?network=sepolia&dkey=AofmxHRJ3EHKtyrFunktN2kf09dd1QER7onqEpnSRlvS')
    // SEPOLIA
    'wss://lb.drpc.org/ogws?network=sepolia&dkey=AofmxHRJ3EHKtyrFunktN2kf09dd1QER7onqEpnSRlvS')
    );

// Define the AAVE Address Provider contract address (SEPOLIA)
const PoolAddressesProviderAddress = '0x012bAC54348C0E635dCAc9D5FB99f06F24136C9A';

// Define the AAVE Address Provider contract address (MAINNET)
...
console.log(poolContract.eventNames());

// Subscribe to the FlashLoan event
poolContract.events.FlashLoan({
    fromBlock: 'latest'
})
.on('data', (event) => {
